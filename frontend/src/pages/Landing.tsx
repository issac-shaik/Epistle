...
export const Landing = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-between flex-grow mx-2 md:mx-32">
        <motion.h1
          initial={{ y: -50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="lg:text-7xl text-5xl sm:mt-36 mt-20 font-bold text-center mb-8"
        >
          <p className="bg-clip-text text-transparent bg-gradient-to-b from-slate-100 to-slate-500">
            A simpler alternative to{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-sky-600">
              Medium.
            </span>
          </p>
          <p className="lg:text-5xl text-2xl bg-clip-text text-transparent bg-gradient-to-b from-slate-100 to-slate-500 pt-8 ">
            All it takes is a minute to register!
          </p>
        </motion.h1>
        <motion.img
          initial={{ y: 50, opacity: 0 }}
